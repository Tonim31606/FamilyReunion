...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddMemberphonenumbers
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddMemberphonenumbers))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703100625209_Add Member phone numbers"
            End Get
        End Property
