...
Namespace Migrations
    ...
    Public NotInheritable Partial Class MakememberIDidentity
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(MakememberIDidentity))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703280251584_Make memberID identity"
            End Get
        End Property
