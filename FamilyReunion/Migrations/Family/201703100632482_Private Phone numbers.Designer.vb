...
Namespace Migrations
    ...
    Public NotInheritable Partial Class PrivatePhonenumbers
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(PrivatePhonenumbers))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703100632482_Private Phone numbers"
            End Get
        End Property
