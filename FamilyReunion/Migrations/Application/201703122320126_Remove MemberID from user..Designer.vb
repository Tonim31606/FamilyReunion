...
Namespace Migrations.Application
    ...
    Public NotInheritable Partial Class RemoveMemberIDfromuser
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(RemoveMemberIDfromuser))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703122320126_Remove MemberID from user."
            End Get
        End Property
