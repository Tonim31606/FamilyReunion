...
Namespace Migrations.Application
    ...
    Public NotInheritable Partial Class LinkMembertouser
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(LinkMembertouser))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201703121606546_Link Member to user"
            End Get
        End Property
